...
const defaults={teamSize:3,botMode:'fill',hunterBots:3,hiderBots:2,hideSeconds:20,roundSeconds:180,teamSelection:'choose',swapTeams:true,objectCount:51,decor:1,idleReveal:30,revealHits:3,escapeBoost:1.1};
...
for(const id of ['team-size','bot-mode','hider-bots','hunter-bots','hide-seconds','round-seconds','object-count','decor','idle-reveal','reveal-hits','escape-boost','team-selection'])$(id).onchange=updateSettings;
